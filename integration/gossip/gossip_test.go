...
func startPeers(network *nwo.Network, peersToStart []*nwo.Peer, peerProc map[string]ifrit.Process, peerRun map[string]ifrit.Runner, forceStateTransfer bool) {
...
func sendTransactionsAndSyncUpPeers(network *nwo.Network, orderer *nwo.Orderer, basePeer *nwo.Peer, peersToSyncUp []*nwo.Peer, channelName string,
	...
	peerProcesses map[string]ifrit.Process, peerRunners map[string]ifrit.Runner) {
