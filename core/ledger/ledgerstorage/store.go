...
func NewProvider(storeDir string, conf *ledger.PrivateData, ledgerconf *ledger.Config) *Provider {
	...
	pvtStoreProvider := pvtdatastorageext.NewProvider(conf, ledgerconf)
