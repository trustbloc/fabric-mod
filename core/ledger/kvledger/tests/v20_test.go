...
func TestV20SampleLedger(t *testing.T) {
	...
	cleanup := xtestutil.SetupV2Data(t, env.initializer.Config)
...
func (d *v20SampleDataHelper) verifyState(h *testhelper) {
	h.verifyPubState("marbles", "marble100", xtestutil.MarbleValue("marble100", "blue", "jerry", 35))
	h.verifyPvtState("marblesp", "collectionMarbles", "marble1", xtestutil.MarbleValue("marble1", "blue", "tom", 35))
