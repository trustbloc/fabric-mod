...
type VersionedDB struct {
	...
	GetStateRangeScanIteratorWithPaginationStub        func(namespace string, startKey string, endKey string, pageSize int32) (statedb.QueryResultsIterator, error)
	...
	ExecuteQueryWithPaginationStub        func(namespace, query, bookmark string, pageSize int32) (statedb.QueryResultsIterator, error)
	...
	GetFullScanIteratorStub        func(skipNamespace func(string) bool) (statedb.FullScanIterator, byte, error)
	...
	ImportStateStub        func(itr statedb.FullScanIterator, dbValueFormat byte) error
...
func (fake *VersionedDB) GetStateRangeScanIteratorWithPagination(namespace string, startKey string, endKey string, pageSize int32) (statedb.QueryResultsIterator, error) {
...
func (fake *VersionedDB) ExecuteQueryWithPagination(namespace string, query string, bookmark string, pageSize int32) (statedb.QueryResultsIterator, error) {
...
func (fake *VersionedDB) GetFullScanIterator(skipNamespace func(string) bool) (statedb.FullScanIterator, byte, error) {
	...
	return fake.getFullScanIteratorReturns.result1, fake.getFullScanIteratorReturns.result2, fake.getFullScanIteratorReturns.result3
}
...
func (fake *VersionedDB) ImportState(itr statedb.FullScanIterator, dbValueFormat byte) error {
	...
	fake.recordInvocation("ImportState", []interface{}{itr, dbValueFormat})
	fake.importStateMutex.Unlock()
	if fake.ImportStateStub != nil {
		return fake.ImportStateStub(itr, dbValueFormat)
	}
	if specificReturn {
		return ret.result1
	}
	return fake.importStateReturns.result1
}
...
func (fake *VersionedDB) ImportStateArgsForCall(i int) (statedb.FullScanIterator, byte) {
	fake.importStateMutex.RLock()
	defer fake.importStateMutex.RUnlock()
	return fake.importStateArgsForCall[i].itr, fake.importStateArgsForCall[i].dbValueFormat
}
...
func (fake *VersionedDB) IsEmpty() (bool, error) {
	...
	return fake.isEmptyReturns.result1, fake.isEmptyReturns.result2
}
...
func (fake *VersionedDB) UpdateCacheCallCount() int {
...
func (fake *VersionedDB) UpdateCacheReturns(result1 error) {
...
func (fake *VersionedDB) UpdateCacheReturnsOnCall(i int, result1 error) {
	fake.UpdateCacheStub = nil
