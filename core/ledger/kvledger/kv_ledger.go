...
type kvLedger struct {
	...
	pvtdataStore           xstorageapi.PrivateDataStore
...
func filterPvtDataOfInvalidTx(hashVerifiedPvtData map[uint64][]*ledger.TxPvtData, blockStore xledgerapi.BlockStore) (map[uint64][]*ledger.TxPvtData, error) {
