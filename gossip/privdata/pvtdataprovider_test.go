...
func TestRetryFetchFromPeer(t *testing.T) {
	...
	storeProvider, err := transientstoreext.NewStoreProvider(tempdir)
...
func setupPrivateDataProvider(t *testing.T,
	...
	storePvtdataOfInvalidTx, skipPullingInvalidTransactions bool, store storageapi.TransientStore,
	rwSetsInCache, rwSetsInTransientStore, rwSetsInPeer []rwSet,
...
func storePvtdataInTransientStore(rwsets []rwSet, store storageapi.TransientStore) error {
	for _, rws := range rwsets {
