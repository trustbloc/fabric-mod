...
const (
	...
	CollectionType_COL_DCAS      CollectionType = 3
)
...
func (CollectionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_collection_60bc87685d099405, []int{0}
}
...
func (*CollectionConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_collection_60bc87685d099405, []int{1}
}
...
func (*StaticCollectionConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_collection_60bc87685d099405, []int{2}
}
...
func (*CollectionPolicyConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_collection_60bc87685d099405, []int{3}
}
...
func (*CollectionCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_collection_60bc87685d099405, []int{4}
}
...
func init() { proto.RegisterFile("common/collection.proto", fileDescriptor_collection_60bc87685d099405) }

var fileDescriptor_collection_60bc87685d099405 = []byte{
	// 598 bytes of a gzipped FileDescriptorProto
	,
}
