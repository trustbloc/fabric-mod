...
func init() {
	proto.RegisterType((*ConfigEnvelope)(nil), "legacy.common.ConfigEnvelope")
	proto.RegisterType((*ConfigGroupSchema)(nil), "legacy.common.ConfigGroupSchema")
	proto.RegisterMapType((map[string]*ConfigGroupSchema)(nil), "legacy.common.ConfigGroupSchema.GroupsEntry")
	proto.RegisterMapType((map[string]*ConfigPolicySchema)(nil), "legacy.common.ConfigGroupSchema.PoliciesEntry")
	proto.RegisterMapType((map[string]*ConfigValueSchema)(nil), "legacy.common.ConfigGroupSchema.ValuesEntry")
	proto.RegisterType((*ConfigValueSchema)(nil), "legacy.common.ConfigValueSchema")
	proto.RegisterType((*ConfigPolicySchema)(nil), "legacy.common.ConfigPolicySchema")
	proto.RegisterType((*Config)(nil), "legacy.common.Config")
	proto.RegisterType((*ConfigUpdateEnvelope)(nil), "legacy.common.ConfigUpdateEnvelope")
	proto.RegisterType((*ConfigUpdate)(nil), "legacy.common.ConfigUpdate")
	proto.RegisterMapType((map[string][]byte)(nil), "legacy.common.ConfigUpdate.IsolatedDataEntry")
	proto.RegisterType((*ConfigGroup)(nil), "legacy.common.ConfigGroup")
	proto.RegisterMapType((map[string]*ConfigGroup)(nil), "legacy.common.ConfigGroup.GroupsEntry")
	proto.RegisterMapType((map[string]*ConfigPolicy)(nil), "legacy.common.ConfigGroup.PoliciesEntry")
	proto.RegisterMapType((map[string]*ConfigValue)(nil), "legacy.common.ConfigGroup.ValuesEntry")
	proto.RegisterType((*ConfigValue)(nil), "legacy.common.ConfigValue")
	proto.RegisterType((*ConfigPolicy)(nil), "legacy.common.ConfigPolicy")
	proto.RegisterType((*ConfigSignature)(nil), "legacy.common.ConfigSignature")
}
