...
func init() {
	proto.RegisterType((*SignedRequest)(nil), "legacy.discovery.SignedRequest")
	proto.RegisterType((*Request)(nil), "legacy.discovery.Request")
	proto.RegisterType((*Response)(nil), "legacy.discovery.Response")
	proto.RegisterType((*AuthInfo)(nil), "legacy.discovery.AuthInfo")
	proto.RegisterType((*Query)(nil), "legacy.discovery.Query")
	proto.RegisterType((*QueryResult)(nil), "legacy.discovery.QueryResult")
	proto.RegisterType((*ConfigQuery)(nil), "legacy.discovery.ConfigQuery")
	proto.RegisterType((*ConfigResult)(nil), "legacy.discovery.ConfigResult")
	proto.RegisterMapType((map[string]*msp.FabricMSPConfig)(nil), "legacy.discovery.ConfigResult.MspsEntry")
	proto.RegisterMapType((map[string]*Endpoints)(nil), "legacy.discovery.ConfigResult.OrderersEntry")
	proto.RegisterType((*PeerMembershipQuery)(nil), "legacy.discovery.PeerMembershipQuery")
	proto.RegisterType((*PeerMembershipResult)(nil), "legacy.discovery.PeerMembershipResult")
	proto.RegisterMapType((map[string]*Peers)(nil), "legacy.discovery.PeerMembershipResult.PeersByOrgEntry")
	proto.RegisterType((*ChaincodeQuery)(nil), "legacy.discovery.ChaincodeQuery")
	proto.RegisterType((*ChaincodeInterest)(nil), "legacy.discovery.ChaincodeInterest")
	proto.RegisterType((*ChaincodeCall)(nil), "legacy.discovery.ChaincodeCall")
	proto.RegisterType((*ChaincodeQueryResult)(nil), "legacy.discovery.ChaincodeQueryResult")
	proto.RegisterType((*LocalPeerQuery)(nil), "legacy.discovery.LocalPeerQuery")
	proto.RegisterType((*EndorsementDescriptor)(nil), "legacy.discovery.EndorsementDescriptor")
	proto.RegisterMapType((map[string]*Peers)(nil), "legacy.discovery.EndorsementDescriptor.EndorsersByGroupsEntry")
	proto.RegisterType((*Layout)(nil), "legacy.discovery.Layout")
	proto.RegisterMapType((map[string]uint32)(nil), "legacy.discovery.Layout.QuantitiesByGroupEntry")
	proto.RegisterType((*Peers)(nil), "legacy.discovery.Peers")
	proto.RegisterType((*Peer)(nil), "legacy.discovery.Peer")
	proto.RegisterType((*Error)(nil), "legacy.discovery.Error")
	proto.RegisterType((*Endpoints)(nil), "legacy.discovery.Endpoints")
	proto.RegisterType((*Endpoint)(nil), "legacy.discovery.Endpoint")
}
