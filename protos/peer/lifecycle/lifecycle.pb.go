...
func init() {
	proto.RegisterType((*InstallChaincodeArgs)(nil), "legacy.lifecycle.InstallChaincodeArgs")
	proto.RegisterType((*InstallChaincodeResult)(nil), "legacy.lifecycle.InstallChaincodeResult")
	proto.RegisterType((*QueryInstalledChaincodeArgs)(nil), "legacy.lifecycle.QueryInstalledChaincodeArgs")
	proto.RegisterType((*QueryInstalledChaincodeResult)(nil), "legacy.lifecycle.QueryInstalledChaincodeResult")
	proto.RegisterType((*QueryInstalledChaincodesArgs)(nil), "legacy.lifecycle.QueryInstalledChaincodesArgs")
	proto.RegisterType((*QueryInstalledChaincodesResult)(nil), "legacy.lifecycle.QueryInstalledChaincodesResult")
	proto.RegisterType((*QueryInstalledChaincodesResult_InstalledChaincode)(nil), "legacy.lifecycle.QueryInstalledChaincodesResult.InstalledChaincode")
	proto.RegisterType((*ApproveChaincodeDefinitionForMyOrgArgs)(nil), "legacy.lifecycle.ApproveChaincodeDefinitionForMyOrgArgs")
	proto.RegisterType((*ChaincodeSource)(nil), "legacy.lifecycle.ChaincodeSource")
	proto.RegisterType((*ChaincodeSource_Unavailable)(nil), "legacy.lifecycle.ChaincodeSource.Unavailable")
	proto.RegisterType((*ChaincodeSource_Local)(nil), "legacy.lifecycle.ChaincodeSource.Local")
	proto.RegisterType((*ApproveChaincodeDefinitionForMyOrgResult)(nil), "legacy.lifecycle.ApproveChaincodeDefinitionForMyOrgResult")
	proto.RegisterType((*CommitChaincodeDefinitionArgs)(nil), "legacy.lifecycle.CommitChaincodeDefinitionArgs")
	proto.RegisterType((*CommitChaincodeDefinitionResult)(nil), "legacy.lifecycle.CommitChaincodeDefinitionResult")
	proto.RegisterType((*QueryApprovalStatusArgs)(nil), "legacy.lifecycle.QueryApprovalStatusArgs")
	proto.RegisterType((*QueryApprovalStatusResults)(nil), "legacy.lifecycle.QueryApprovalStatusResults")
	proto.RegisterMapType((map[string]bool)(nil), "legacy.lifecycle.QueryApprovalStatusResults.ApprovedEntry")
	proto.RegisterType((*QueryChaincodeDefinitionArgs)(nil), "legacy.lifecycle.QueryChaincodeDefinitionArgs")
	proto.RegisterType((*QueryChaincodeDefinitionResult)(nil), "legacy.lifecycle.QueryChaincodeDefinitionResult")
	proto.RegisterType((*QueryNamespaceDefinitionsArgs)(nil), "legacy.lifecycle.QueryNamespaceDefinitionsArgs")
	proto.RegisterType((*QueryNamespaceDefinitionsResult)(nil), "legacy.lifecycle.QueryNamespaceDefinitionsResult")
	proto.RegisterMapType((map[string]*QueryNamespaceDefinitionsResult_Namespace)(nil), "legacy.lifecycle.QueryNamespaceDefinitionsResult.NamespacesEntry")
	proto.RegisterType((*QueryNamespaceDefinitionsResult_Namespace)(nil), "legacy.lifecycle.QueryNamespaceDefinitionsResult.Namespace")
}
