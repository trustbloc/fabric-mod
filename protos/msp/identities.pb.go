...
func init() {
	proto.RegisterType((*SerializedIdentity)(nil), "legacy.msp.SerializedIdentity")
	proto.RegisterType((*SerializedIdemixIdentity)(nil), "legacy.msp.SerializedIdemixIdentity")
}
