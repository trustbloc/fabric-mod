...
func addBlocksToStore(t *testing.T, store extledgerapi.BlockStore, numBlocks int) []*common.Block {
...
func checkBlocks(t *testing.T, expectedBlocks []*common.Block, store extledgerapi.BlockStore) {
...
func checkWithWrongInputs(t *testing.T, store extledgerapi.BlockStore, numBlocks int) {
...
func TestBlockStoreProvider(t *testing.T) {
	...
	var stores []extledgerapi.BlockStore
	numStores := 10
