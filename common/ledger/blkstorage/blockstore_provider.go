...
func (p *BlockStoreProvider) Open(ledgerid string) (extledgerapi.BlockStore, error) {
...
func (p *BlockStoreProvider) BootstrapFromSnapshottedTxIDs(
	snapshotDir string, snapshotInfo *extledgerapi.SnapshotInfo) (extledgerapi.BlockStore, error) {
